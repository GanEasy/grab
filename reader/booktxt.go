...
func (r BooktxtReader) GetCategories(urlStr string) (list Catalog, err error) {
	...
	list.Cards = []Card{
		Card{`全部`, `/pages/transfer/list?action=list&drive=booktxt&url=` + EncodeURL(`https://m.booktxt.net/wapsort/0_1.html`), "", `link`, ``, nil},
		Card{`玄幻`, `/pages/transfer/list?action=list&drive=booktxt&url=` + EncodeURL(`https://m.booktxt.net/wapsort/1_1.html`), "", `link`, ``, nil},
		Card{`修真`, `/pages/transfer/list?action=list&drive=booktxt&url=` + EncodeURL(`https://m.booktxt.net/wapsort/2_1.html`), "", `link`, ``, nil},
		Card{`都市`, `/pages/transfer/list?action=list&drive=booktxt&url=` + EncodeURL(`https://m.booktxt.net/wapsort/3_1.html`), "", `link`, ``, nil},
		Card{`穿越`, `/pages/transfer/list?action=list&drive=booktxt&url=` + EncodeURL(`https://m.booktxt.net/wapsort/4_1.html`), "", `link`, ``, nil},
		Card{`网游`, `/pages/transfer/list?action=list&drive=booktxt&url=` + EncodeURL(`https://m.booktxt.net/wapsort/5_1.html`), "", `link`, ``, nil},
		Card{`科幻`, `/pages/transfer/list?action=list&drive=booktxt&url=` + EncodeURL(`https://m.booktxt.net/wapsort/6_1.html`), "", `link`, ``, nil},
		Card{`其他`, `/pages/transfer/list?action=list&drive=booktxt&url=` + EncodeURL(`https://m.booktxt.net/wapsort/7_1.html`), "", `link`, ``, nil},
	}
	return list, nil
}
