...
func (r BxksReader) GetCategories(urlStr string) (list Catalog, err error) {
	...
	list.Cards = []Card{
		...
		Card{`悬疑灵异`, `/pages/list?action=book&drive=bxks&url=` + EncodeURL(`https://www.jininggeyin.com/ji/18.html`), "", `link`, ``, nil, ``, ``},
		...
		Card{`其他`, `/pages/list?action=book&drive=bxks&url=` + EncodeURL(`https://www.jininggeyin.com/ji/18.html`), "", `link`, ``, nil, ``, ``},
	}
